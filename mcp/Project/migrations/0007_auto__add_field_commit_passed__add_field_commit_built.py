...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Commit.passed'
        db.add_column('Project_commit', 'passed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Commit.built'
        db.add_column('Project_commit', 'built',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Commit.passed'
        db.delete_column('Project_commit', 'passed')

        # Deleting field 'Commit.built'
        db.delete_column('Project_commit', 'built')
