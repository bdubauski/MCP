...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'GitProject'
        db.create_table('Project_gitproject', (
        ...
        db.send_create_signal('Project', ['GitProject'])

        # Deleting field 'GitHubProject.github_url'
        db.delete_column('Project_githubproject', 'github_url')

        # Adding field 'GitHubProject.git_url'
        db.add_column('Project_githubproject', 'git_url',
                      self.gf('django.db.models.fields.CharField')(default='<unknown>', max_length=200),
                      keep_default=False)

        # Adding field 'GitHubProject.repo_name'
        db.add_column('Project_githubproject', 'repo_name',
                      self.gf('django.db.models.fields.CharField')(default='<unknwon>', max_length=200),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'GitHubProject.github_url'
        raise RuntimeError("Cannot reverse this migration. 'GitHubProject.github_url' and its values cannot be restored.")
        # Deleting field 'GitHubProject.git_url'
        db.delete_column('Project_githubproject', 'git_url')

        # Deleting field 'GitHubProject.repo_name'
        db.delete_column('Project_githubproject', 'repo_name')
    ...
    models = {
        ...
        'Project.githubproject': {
            ...
            'repo_name': ('django.db.models.fields.CharField', [], {'max_length': '200'})
        },
        'Project.gitproject': {
