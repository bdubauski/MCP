...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.rename_column('Project_githubproject', 'repo', '_repo')

        # Deleting field 'GitHubProject.org'
        db.rename_column('Project_githubproject', 'org', '_org')

    def backwards(self, orm):
        # Deleting field 'GitHubProject.repo'
        db.rename_column('Project_githubproject', '_repo', 'repo')

        # Deleting field 'GitHubProject.org'
        db.rename_column('Project_githubproject', '_org', 'org')
