...
def load_builtins( app, schema_editor ):
  ...
  for name in ( 'trusty', 'precise', 'xenial', 'centos6' ):
    ...
    br = BuildResource( name='target', build=b, resource=Resource.objects.get( pk='small-generic-{0}'.format( name ) ) )
    br.quanity = 1
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('docs_results', mcp.fields.MapField(blank=True, default={})),
                ...
                ('docs_at', models.DateTimeField(blank=True, editable=False, null=True)),
