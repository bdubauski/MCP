...
class Migration(SchemaMigration):
    ...
    depends_on = (("Resource", "0003_auto__add_networkresource"),)

    def forwards(self, orm):
        # Adding model 'BuildJobNetworkResource'
        db.create_table('Processor_buildjobnetworkresource', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('buildjob', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Processor.BuildJob'])),
            ('networkresource', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Resource.NetworkResource'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('Processor', ['BuildJobNetworkResource'])
