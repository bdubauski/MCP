...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'BuildJobNetworkResource', fields ['buildjob', 'name']
        db.create_unique('Processor_buildjobnetworkresource', ['buildjob_id', 'name'])


    def backwards(self, orm):
        # Removing unique constraint on 'BuildJobNetworkResource', fields ['buildjob', 'name']
        db.delete_unique('Processor_buildjobnetworkresource', ['buildjob_id', 'name'])
