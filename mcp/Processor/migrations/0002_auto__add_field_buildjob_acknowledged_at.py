...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BuildJob.acknowledged_at'
        db.add_column('Processor_buildjob', 'acknowledged_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


        for job in orm.BuildJob.objects.all():
          job.acknowledged_at = job.reported_at
          job.save()

    def backwards(self, orm):
        # Deleting field 'BuildJob.acknowledged_at'
        db.delete_column('Processor_buildjob', 'acknowledged_at')
