...
# symlink to /etc/mcp/master.conf.  Any Content in this file is lost when the
...
#
# git update-index --assume-unchanged mcp/settings.py
#
# to keep git from sending up stream your changes.
# if you really do want to change this file, run:
#
# git update-index --no-assume-unchanged mcp/settings.py
#
